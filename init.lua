--[[
For more info about lua
  - https://learnxinyminutes.com/docs/lua/
  - :help lua-guide

Addition help:
  - :help X
  Replacing X with any key will bring you to the help documentation for that key
  - "<space>sh"
  This allows you to search the help documentation
  - :checkhealth
  This can help if there are errors with installation, nvim or plugin
--]]
